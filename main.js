...
LexxyOFC.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "6281392717132@s.whatsapp.net"
...
LexxyOFC.on("group-update", async (anu) => {
    ...
    if (anu.announce == "false") {
      ...
      teks = `- [ Group Closed ] -\n\n_Group telah ditutup oleh admin_\n_Transaksi mohon untuk di tahan dulu...._`;
...
LexxyOFC.on('group-update', async (anu) => {
    ...
    LexxyOFC.on('chat-update', async (message) => {
        ...
        ownerNumber = ["6281392717132@s.whatsapp.net","6285156346076@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "6281392717132@s.whatsapp.net"
